...
1. **（取得収益の受取）**
	...
	1. ノアドットは、前項の定めによる締日の翌々月末日までに、前項の明細に基づく本取得収益ならびにこれに対する消費税および地方消費税を、必要に応じて所定の税額の源泉徴収を行ったうえで、パブリッシャーの指定する銀行口座に振り込む方法で支払います。ただし、支払総額が10,000円未満（パブリッシャーが日本国外の銀行口座を指定した場合は50,000円未満）の場合は翌月以降に繰り越し、10,000円以上（パブリッシャーが日本国外の銀行口座を指定した場合は50,000円以上）となった月に支払を行うものとします。なお、振込手数料はノアドットの負担とします。
	...
	1. パブリッシャーが、第ii項の支払総額が10,000円未満（パブリッシャーが日本国外の銀行口座を指定した場合は50,000円未満）の状態で本契約を解約した場合、ノアドットは解約した月の翌々月末までに、パブリッシャーの指定する銀行口座に振り込みます。なお、振込手数料はパブリッシャーの負担とします。
...
1. **（合意管轄）**  
本契約に関する訴訟については、訴額に応じ東京地方裁判所または東京簡易裁判所を第一審の専属的合意管轄裁判所とします。ただし、パブリッシャーの登記地または居住地が日本国外である場合の本契約に関する訴訟については、その解決にあたってパブリッシャーとノアドットは米国ニューヨーク州ニューヨーク郡の州裁判所または連邦裁判所の裁判管轄権に従うものとします。

1. **（準拠法）**  
本契約の成立、効力、履行および解釈については日本法に準拠します。ただし、パブリッシャーの登記地または居住地が日本国外である場合の本契約の成立、効力、履行および解釈については米国ニューヨーク州法に準拠します。
