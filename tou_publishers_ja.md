...
1. **（取得収益の受取）**
	...
	1. ノアドットは、前項の定めによる締日の翌々月末日までに、前項の明細に基づく本取得収益ならびにこれに対する消費税および地方消費税を、必要に応じて所定の税額の源泉徴収を行ったうえで、パブリッシャーの指定する銀行口座に振り込む方法で支払います。ただし、支払総額が10,000円未満（パブリッシャーが日本国外の銀行口座を指定した場合は50,000円未満）の場合は翌月以降に繰り越し、10,000円以上（（パブリッシャーが日本国外の銀行口座を指定した場合は50,000円未満）となった月に支払を行うものとします。なお、振込手数料はノアドットの負担とします。
