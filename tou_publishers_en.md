...
For the purposes of these TOU, the following terms shall have the following meanings:
	...
	1. "Member" refers to a person, who uses the nor. Service by agreeing and complying with the [Terms of Use for Members](https://github.com/nordot/otherthancode/blob/master/tou_members_en.md).
...
1. **Storage, retrieval, and distribution of Curation**
	...
	1. Publisher may distribute its Curation stored in its Media Unit to a User from a web server operated by Publisher, after retrieving the Curation pursuant to Section 8.iv. Publisher shall not alter any Lead-in constituting the Curation, unless it is a Lead-in created by Publisher.
...
1. **Receipt of acquired profits**
	...
	1. If Publisher terminates these TOU while the total amount of payment under Section 12.ii is less than 10,000 JPY (or for Publisher with a bank account outside Japan, less than 50,000 USD), Nordot shall transfer the amount to a bank account designated by Publisher by the end of the month following the one immediately after the month of termination. Publisher shall pay the bank transfer fee.
...
1. **Representations and warranties**
	...
	1. Publisher represents and warrants that it agrees to comply with the [Content Guidelines for the nor. Service](https://github.com/nordot/otherthancode/blob/master/guidelines_en.md)
...
1. **Termination and forfeiture of benefit of time**
	...
	1. In cases where Nordot terminates this Agreement due to Section 30.1.a, 30.1.b, 30.1.c, or 30.1.k, Nordot shall keep Acquired Profits if any amount is in unpaid status under the provisions of Section 12.
